    ...
    <div className='relative my-6 md:my-12 font-spartan'>
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
          ...
          >
            <motion.h2 
              className="hidden lg:block absolute top-[2rem] right-[8rem] xl:right-[20rem] text-[8rem] xl:text-[12rem] font-bold text-gray-100 z-50 select-none pointer-events-none"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
